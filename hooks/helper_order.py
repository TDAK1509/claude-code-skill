...
def report(path, violations):
    ...
    head += [
        ...
        "",
        "This reads the whole file, not your added lines. If the disorder is older",
        "than your edit, reorder it anyway: you have the file open and the move",
        "changes no behaviour. Cut and paste only, and commit the move on its own.",
        "",
