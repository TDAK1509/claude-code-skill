...
> `skills/test-driven-development/SKILL.md`, pinned to commit
...
For anything that runs in a browser, unit tests alone aren't enough — you need runtime verification (DOM inspection, console logs, network requests, screenshots) via a Chrome DevTools MCP or equivalent, if one is connected in this session.
